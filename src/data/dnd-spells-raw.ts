import type { DndSpellRaw } from "../models/dnd";

export const dndSpellsRaw: DndSpellRaw[] = [
  {
  ...
  },
  {
    ...
    components: {
      material: true,
      materials_needed: ["Tiny tarts", "A feather that is waved in the air"],
  ...
  },
  {
    ...
    components: {
      material: true,
      materials_needed: ["A drop of mercury"],
